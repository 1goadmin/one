	...
	<header class="container-fluid nav-container" style= "z-index:2">
		<nav class="container navigation">
			<ul class="menunav" style="margin-left:.02rem;">
				<li class="logo" style="text-align:left;"><a  href="<?=bloginfo('url');?>/"><img class="invlogo" src="<?=bloginfo('url');?>/wp-content/themes/onetheme/img/logintl.svg" alt="logo" style="width: 4.5rem; height:auto; margin-top:5px; position:relative;"></a></li>
