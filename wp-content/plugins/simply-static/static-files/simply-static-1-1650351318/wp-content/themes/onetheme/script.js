...
$(document).ready(function () {
  ...
  $(window).scroll(function () {
    $(window).scrollTop() >= 50
      ? ($("header").addClass("scrolled"), $(".menu").addClass("scrolled2"))
...
$(document).ready(function () {
  // Function to change the nav-bar on scroll
  $(window).scroll(function () {
    let initialSrc = "https://ferlerrorr.github.io/one/wp-content/themes/onetheme/img/logointl.svg";
    let scrollSrc = "https://ferlerrorr.github.io/one/wp-content/themes/onetheme/img/logoinv.svg";
